...
/*   Updated: 2025/02/12 16:23:57 by darkless12       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_floor(t_all *all)
{
	...
	printf("%d x %d, bpp:%d, line:%d\n", all->floor[0].x, all->floor[0].y, all->floor[0].bpp, all->floor[0].line);
	...
	printf("%d x %d, bpp:%d, line:%d\n", all->floor[1].x, all->floor[1].y, all->floor[1].bpp, all->floor[1].line);
	...
	printf("%d x %d, bpp:%d, line:%d\n", all->floor[2].x, all->floor[2].y, all->floor[2].bpp, all->floor[2].line);
}
